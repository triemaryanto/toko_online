            ...
            <nav class="navbar navbar-expand-lg center-nav navbar-light navbar-bg-light">
                <div class="container flex-lg-row flex-nowrap align-items-center">
                    <div class="navbar-brand w-100">
                        <a href="./index.html">
                            <img src="{{asset('sandbox/assets/img/logo.png') }}" srcset="./assets/img/logo@2x.png 2x" alt="" />
                        </a>
                    </div>
                            ...
                            <div class="swiper">
                                <div class="swiper-wrapper">
                                    <div class="swiper-slide bg-overlay bg-overlay-400 rounded">
                                        <img src="{{ asset('sandbox/assets/img/photos/is1.jpg') }}" alt="" />

                                        <!--/.caption-wrapper -->
                                    </div>
                                    <!--/.swiper-slide -->
                                    <div class="swiper-slide rounded">
                                        <img src="{{ asset('sandbox/assets/img/photos/is2.jpg') }}" alt="" />

                                        <!--/.caption-wrapper -->
                                    </div>
                                    <!--/.swiper-slide -->
                                    <div class="swiper-slide"><img src="{{ asset('sandbox/assets/img/photos/is3.jpg') }}" class="rounded" alt="" /></div>
                                </div>
                                <!--/.swiper-wrapper -->
                            </div>
                            <!-- /.swiper -->
            ...
            <div class="container py-12 py-md-14">
                <div class="row gx-lg-8 gx-xl-12 gy-8">
                    <div class="col-md-6 col-lg-4">
                        <div class="d-flex flex-row">
                            <div>
                                <img src="{{ asset('sandbox/assets/img/icons/solid/shipment.svg') }}" class="svg-inject icon-svg icon-svg-sm solid-mono text-navy me-4" alt="" />
                            </div>
                            <div>
                    ...
                    <div class="col-md-6 col-lg-4">
                        <div class="d-flex flex-row">
                            <div>
                                <img src="{{ asset('sandbox/assets/img/icons/solid/push-cart.svg') }}" Sclass="svg-inject icon-svg icon-svg-sm solid-mono text-navy me-4" alt="" />
                            </div>
                            <div>
                    ...
                    <div class="col-md-6 col-lg-4">
                        <div class="d-flex flex-row">
                            <div>
                                <img src="{{ asset('sandbox/assets/img/icons/solid/verify.svg') }}" class="svg-inject icon-svg icon-svg-sm solid-mono text-navy me-4" alt="" />
                            </div>
                            <div>
